...
Funcionalidade: Funcionalidade 31

Cenário: Funcionalidade 31 - Cenário Geral

	Variante: 1 - Funcionalidade 31
		...
		Então eu tenho ~funcionalidade 31~

	Variante: 2 - Funcionalidade 31
		Dado que eu estou em "http://localhost/dolibarr/htdocs/public/members/new.php"
		Quando eu seleciono {Type}
			E eu seleciono {Morphy}
			E eu preencho {Prenom}
